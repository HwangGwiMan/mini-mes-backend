...
@ApplicationModule(allowedDependencies = {"goodsreceipt::application", "warehouse::application", "item::application", "common::domain", "common::exception", "common::util", "jooq::tables"})
