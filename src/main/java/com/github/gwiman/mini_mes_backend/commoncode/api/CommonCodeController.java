...
public class CommonCodeController {
	...
	public List<CommonCodeResponse> getAll(
		...
		return commonCodeService.findAll(codeGroup, code, name);
	}
	...
	public CommonCodeResponse create(@RequestBody @Valid CommonCodeRequest request) {
	...
	public CommonCodeResponse update(
		...
		@RequestBody @Valid CommonCodeRequest request
	) {
		return commonCodeService.update(id, request);
	}
